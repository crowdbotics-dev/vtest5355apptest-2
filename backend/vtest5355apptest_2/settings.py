"""
Django settings for vtest5355apptest_2 project.
...
ROOT_URLCONF = 'vtest5355apptest_2.urls'
...
WSGI_APPLICATION = 'vtest5355apptest_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "vtest5355apptest Support <support@vtest5355apptest-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vtest5355apptest_2 API",
    "DESCRIPTION": "API documentation for vtest5355apptest_2 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "vtest5355apptest_2.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "vtest5355apptest_2.storage_backends.AzureStaticStorage"
